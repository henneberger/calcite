...
/** Workspace methods; currently no-op hooks. */
class CalciteWorkspaceService implements WorkspaceService {
  @Override public void didChangeConfiguration(DidChangeConfigurationParams params) {
    // Config reload can be added in a future iteration.
  }

  @Override public void didChangeWatchedFiles(DidChangeWatchedFilesParams params) {
    // No workspace file watcher behavior yet.
  }
}
